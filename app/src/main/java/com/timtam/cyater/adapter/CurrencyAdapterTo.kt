...
class CurrencyAdapterTo(
    ...
    inner class CustomViewHolder(view: View): RecyclerView.ViewHolder(view), View.OnClickListener {
        ...
        override fun onClick(v: View) {
            onViewItemClickListener.itemToClicked(dataSet[this.adapterPosition])
        }

    }

    interface RecyclerViewItemClickListener {
        fun itemToClicked(country: Country)
    }
}